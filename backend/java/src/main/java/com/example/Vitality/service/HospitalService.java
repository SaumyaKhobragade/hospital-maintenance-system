...
public class HospitalService {
    ...
    private void treatPatient(Hospital h, Department dept, Patient p) {
        ...
        try {
            ...
            sseService.broadcastEvent(startEvent);
        } catch (Exception e) {
        ...
        try {
            ...
            try {
                ...
                sseService.broadcastEvent(endEvent);
            } catch (Exception e) {
    ...
    public void updatePatientDistress(String patientId, com.example.HMS.model.DistressStatus status) {
        Patient p = masterPatientIndex.get(patientId);
        if (p != null) {
